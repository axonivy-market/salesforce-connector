...
public class OAuth2Feature implements Feature {
  ...
  public boolean configure(FeatureContext context) {
    ...
    OAuth2TokenRequester requestor = ctxt -> requestToken(ctxt, graphUri);
    var oauth2 = new SalesforceOAuth2Filter(requestor, graphUri);
  ...
  private static Response requestToken(AuthContext ctxt, OAuth2UriProperty uriFactory) {
    ...
    return ctxt.target.request().accept(MediaType.WILDCARD).post(Entity.form(form));
  }
