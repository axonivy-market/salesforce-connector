...
public class OAuth2FeatureNew implements Feature {
	...
	public boolean configure(FeatureContext context) {
		var config = new FeatureConfig(context.getConfiguration(), OAuth2FeatureNew.class);
	...
	private static Response requestToken(AuthContextNew ctxt, OAuth2UriProperty uriFactory) {
