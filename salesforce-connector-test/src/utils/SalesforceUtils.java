...
public class SalesforceUtils {
	...
	public static void setUpConfigForApiTest(AppFixture fixture) {
		...
		fixture.var("salesforce-connector.auth.url", url);
		fixture.var("salesforce-connector.auth.subdomain", subDomain);
		fixture.var("salesforce-connector.auth.clientId", clientId);
		fixture.var("salesforce-connector.auth.clientSecret", clientSecret);
	}
